...
list1 =  read.csv("C://Users//Ramya Karukonda//Downloads//listings.csv", header=TRUE, stringsAsFactors = FALSE)
...
calendar =  read.csv("C://Users//Ramya Karukonda//Downloads//calendar.csv", header=TRUE, stringsAsFactors = FALSE)
